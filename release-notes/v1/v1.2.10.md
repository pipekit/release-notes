...
## What's Changed
### New Features 🎉
* feat: add upcoming metrics option to Agent Helm install. Register your interest for free Workflow Metrics at https://pipekit.io/metrics-signup
* fix: CLI token permissions
